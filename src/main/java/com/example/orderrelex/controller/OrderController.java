...
public class OrderController {
     ...
     * @param startDate начальная дата отсчета (невкл.), напр., 2024-03-01
     * @param endDate конечная дата (невкл.), напр., 2024-03-10
     * @param employeeId идентификационный номер сотрудника
     * @return все товары, собранные конкретным сотрудником за период времени,
     * в данном случае с 2024-03-02 по 2024-03-09 (вкл.)
     */
